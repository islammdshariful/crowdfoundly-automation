...
//            Runtime.getRuntime().exec("C:\\Users\\shari\\IdeaProjects\\CROWDFUNDLY\\autoit\\CreateCampaign\\Story\\stry_fileupload.exe");
    ...
    public static void Quickcreate(WebDriver driver, String cmp_type, String duration, String do_donate) {
        Menus.clickCampaigns();
...
//            driver.findElement(By.xpath(CampaignPage.Locators.add_new_xpth)).click();
            ...
            String titleName = name.replace(":", "");

            // Write title
            driver.findElement(By.xpath(NewCampaign.Locator.cam_title_xpth)).click();
            driver.findElement(By.xpath(NewCampaign.Locator.cam_title_xpth)).clear();
            if (cmp_type.equals("reward") && duration.equals("nodate")) {
                driver.findElement(By.xpath(NewCampaign.Locator.cam_title_xpth)).sendKeys(titleName + NewCampaign.Text.rwd_nodate_cmp_title_txt);
            } else if (cmp_type.equals("reward") && duration.equals("date")) {
                driver.findElement(By.xpath(NewCampaign.Locator.cam_title_xpth)).sendKeys(titleName +  NewCampaign.Text.rwd_date_cmp_title_txt);
            } else if (cmp_type.equals("donation") && duration.equals("nodate")) {
                driver.findElement(By.xpath(NewCampaign.Locator.cam_title_xpth)).sendKeys(titleName + NewCampaign.Text.donate_nodate_cmp_title_txt);
            } else {
                driver.findElement(By.xpath(NewCampaign.Locator.cam_title_xpth)).sendKeys(titleName + NewCampaign.Text.donate_date_cmp_title_txt);
            }
            driver.findElement(By.xpath(NewCampaign.Locator.cmp_title_nxt_btn_xpth)).click();
